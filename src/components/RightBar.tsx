      ...
      <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
        <article className="my-6 flex justify-between gap-4">
          ...
          >
            ...
            >
              <h2 className="text-center text-lg font-bold">Chuỗi</h2>
              <p className="text-center text-sm font-normal text-gray-400">
                {`Nhưng chuỗi của bạn sẽ bị xóa vào ngày mai nếu bạn không luyện tập vào ngày mai. Hãy cẩn thận!`}
              </p>
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm font-normal text-gray-400">
                  Bạn sở hữu {lingots} {lingots === 1 ? "lingot" : "lingots"}.
                </p>
                <Link
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      <h2 className="text-xl font-bold">Mở khóa bảng xếp hạng</h2>
      <div className="flex items-center gap-6">
        <LockedLeaderboardsSvg />
        <p className="text-sm leading-6 text-gray-500">
          Hoàn thành {lessonsNeededToUnlockLeaderboards} thêm bài học
          {lessonsNeededToUnlockLeaderboards === 1 ? "" : "s"} để bắt đầu
          cạnh tranh
        </p>
      </div>
    </article>
        ...
        <div className="flex flex-col gap-5">
          {rank !== null && (
            <p className="text-lg font-bold text-gray-700">
              {`Bạn được xếp hạng #${rank}`}
            </p>
          )}
          <p className="text-sm leading-6 text-gray-500">
          Bạn đã kiếm được {xpThisWeek} XP tuần này cho đến nay
          </p>
        </div>
      </div>
    </article>
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <h2 className="text-xl">Nhiệm vụ hàng ngày</h2>
      <div className="flex items-center gap-4">
        <LightningProgressSvg />
        <div className="flex flex-col gap-2">
          <h3>Thu thập {goalXp} XP</h3>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
      <h2 className="text-xl">Tạo hồ sơ để lưu tiến trình của bạn!</h2>
      <button
